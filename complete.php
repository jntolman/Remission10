    ...
    <section id="mustang-confirm" class="bg-darkest-gray">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <?php
                    include('vendor/paypal/mustang-complete.php');
                ?>
